export const about = {
  ...
  sections: [
    ...
    },
    {
      heading: "What I do",
      items: [
        "CRE operations and financial analysis — lease administration, construction draws, property management reporting",
        "AI prompt engineering — structured extraction systems for legal documents, loan packages, and lease agreements",
        "Excel modeling — construction budgets, tenant improvement trackers, DSCR calculators, billback reconciliation",
        "Python automation — document generation, data consolidation, report pipelines",
      ],
    },
    {
      heading: "How I work",
